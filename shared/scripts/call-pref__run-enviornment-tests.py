...
def main():
    ...
    self_abs_path = path.basename(path.abspath('call-pref__run-enviornment-tests.py'))

    print("(PREF @ " + self_abs_path + ") -> env.Dump(): [")
    print(env.Dump() + "]\n")
    print("(PREF @ " + self_abs_path + ") -> projenv.Dump(): [N/A]\n")
